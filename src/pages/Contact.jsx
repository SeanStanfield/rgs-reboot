...
import {Button, Card, Grid, Input, Stack, TextField, Typography, useMediaQuery} from "@mui/material";
		...
		<Styles>
			...
			<Grid container className='hero'>
				<Grid item className='hero-text' xs={12} md={6}>
					...
					<Typography variant='body1' className='hero-text-body'>If you're experiencing any roofing issues or
						have any questions regarding our services, please don't hesitate to fill out the form below and
					...
					<Card className='card'>
						...
						<form action="https://api.web3forms.com/submit" method="POST" id="form" className='form'>
							...
							<div className="input-field full">
								<TextField fullWidth label='Full Name' variant='filled' type="text" name="name" id="name" required/>
							</div>
							<div className="input-field half email">
								<TextField fullWidth label='Email' type="email" variant='filled' name="email" id="email" placeholder="you@company.com" required/>
							</div>
							<div className="input-field half">
								<TextField fullWidth label='Phone number' type="tel" variant='filled' name="phone" id="phone" required/>
							</div>
							<div className="input-field full">
								<TextField fullWidth label='Your message' multiline={true} rows={4} variant='filled' name="message" id="message" placeholder="Let us know how we can help." required></TextField>
							</div>

                ...
                <img src='assets/svg/cross.svg' alt='Cross sign'/>
					...
					<main>
						<Box className='hero-background'
						     sx={{backgroundImage: `url(${pageData?.attributes?.[!mobile ? 'heroImageDesktop' : 'heroImageMobile']?.data?.attributes?.url})`}}>
							<Container>
						...
						<Stack className='what-we-do' justifyContent='center' alignItems='center'>
							...
							<Typography variant='body1' className='what-we-do-description'>Every year, thousands of
								homeowners with flat roofs complain of cracks and leakage. Most felt or asphalt flat
								roofs
										...
										<Grid container spacing={4} className='slider-grid'>
											<Grid item md={6} className='slider-text'>
												<Stack justifyContent='center' className='slider-text-content'>
													...
													<Typography variant='body1' className='para'>While we know that
														E.P.D.M
														may not
												...
												<Stack justifyContent='center' className='slider-text-content'>
													<Stack direction='row' alignItems='flex-start'>
														<img src='/assets/svg/clock-solid.svg' alt='arrow down'
														     className='title-icon'/>
														<Typography variant='h3' className='title'>Long
															Lasting</Typography>
													</Stack>

													<Typography variant='body1' className='para'>we specialize in
														providing
														long-lasting E.P.D.M roofing solutions for flat
														roofs.</Typography>
													...
													<Typography variant='body1' className='para'> Our commitment to
														using
														high-quality materials, employing experienced and skilled
														roofers,
														and adhering to the highest industry standards ensures that our
														roof
														repair services provide peace of mind for years to come. Contact
														us
														today for durable and reliable flat roofing
						...
						<section className='reviews'>
							...
							<Stack className='what-we-do' justifyContent='center' alignItems='center'>
								<Typography variant='h2'
								            className='what-we-do-title'>{pageData?.resultsTitle}</Typography>
						...
						<SocialProof images={pageData?.attributes?.brands}/>
